...
with open("results.txt", "r") as f:
    ...
    quiz: [
      { question: "Which mode opens a file for writing and overwrites any existing content?", options: ["r", "a", "w", "x"], correctIndex: 2, explanation: "'w' (write) mode creates a new file or overwrites an existing one.", hint: "Pseudocode: OPEN file FOR WRITING. This mode destroys existing content.", difficulty: "easy" },
      { question: "What does the 'a' mode do when opening a file?", options: ["Reads the file", "Overwrites the file", "Appends to the end", "Deletes the file"], correctIndex: 2, explanation: "'a' (append) mode adds content to the end of an existing file.", hint: "Pseudocode: OPEN file FOR APPENDING. 'a' stands for append — adds to the end.", difficulty: "easy" },
      { question: "Why should you use 'with open(...) as f:'?", options: ["It runs faster", "It automatically closes the file", "It is the only way to open files", "It encrypts the file"], correctIndex: 1, explanation: "The 'with' statement ensures the file is closed properly when the block finishes.", hint: "Pseudocode: OPEN file ... CLOSE file. 'with' handles the CLOSE automatically.", difficulty: "easy" },
      { question: "What error occurs if you try to read a file that doesn't exist?", options: ["TypeError", "NameError", "FileNotFoundError", "IOError"], correctIndex: 2, explanation: "Python raises a FileNotFoundError if the file doesn't exist when opening in 'r' mode.", hint: "The error name describes exactly what went wrong — the file was not found.", difficulty: "medium" },
      { question: "What method reads the entire file content as a single string?", options: ["readline()", "readlines()", "read()", "readall()"], correctIndex: 2, explanation: "read() returns the entire file content as a single string.", hint: "Pseudocode: content ← file.read(). This reads EVERYTHING into one string.", difficulty: "easy" },
      { question: "What is the difference between read() and readlines()?", options: ["No difference", "read() returns a string, readlines() returns a list", "readlines() is faster", "read() only reads one line"], correctIndex: 1, explanation: "read() returns the entire file as one string. readlines() returns a list where each item is a line.", hint: "Pseudocode: lines ← file.readlines() gives a list like ['line1\\n', 'line2\\n'].", difficulty: "medium" },
      { question: "What does f.write(str(42)) do?", options: ["Writes the integer 42", "Writes the string '42'", "Error — cannot write numbers", "Writes 'str(42)'"], correctIndex: 1, explanation: "str(42) converts the integer to string '42', which is then written to the file.", hint: "write() only accepts strings. You must cast numbers with str() first.", difficulty: "medium" },
      { question: "What happens if you open an existing file in 'w' mode?", options: ["It adds to the end", "Error — file already exists", "The existing content is deleted", "Nothing happens"], correctIndex: 2, explanation: "'w' mode overwrites — it deletes all existing content before writing new data.", hint: "WARNING: 'w' mode is destructive! It erases everything in the file first.", difficulty: "hard" },
      { question: "How do you read a file line by line in a loop?", options: ["for line in f.read():", "for line in f:", "while f.readline():", "for line in f.lines():"], correctIndex: 1, explanation: "You can iterate directly over a file object: for line in f: reads one line at a time.", hint: "Pseudocode: WHILE NOT EOF\n    line ← READLINE(file)\nENDWHILE\nIn Python: for line in f:", difficulty: "hard" }
    ]
  },
  ...
  "error-handling": {
    ...
    quiz: [
      { question: "What keyword begins an error-handling block?", options: ["catch", "except", "try", "handle"], correctIndex: 2, explanation: "The 'try' keyword starts the block of code that might raise an exception.", hint: "Pseudocode: TRY ... CATCH. In Python the first keyword is 'try'.", difficulty: "easy" },
      { question: "What exception occurs when dividing by zero?", options: ["ValueError", "ZeroDivisionError", "ArithmeticError", "MathError"], correctIndex: 1, explanation: "Python raises ZeroDivisionError when you try to divide by zero.", hint: "The error name describes exactly what happened — division by zero.", difficulty: "easy" },
      { question: "Which block of code always runs, error or not?", options: ["else", "except", "finally", "always"], correctIndex: 2, explanation: "The 'finally' block executes regardless of whether an exception was raised.", hint: "Pseudocode: TRY ... CATCH ... FINALLY. This block runs no matter what.", difficulty: "medium" },
      { question: "What error occurs if you try to convert 'hello' to an integer?", options: ["NameError", "TypeError", "ValueError", "InputError"], correctIndex: 2, explanation: "ValueError is raised when a conversion fails due to inappropriate value.", hint: "The value 'hello' is not valid for int(). This raises a Value___.", difficulty: "easy" },
      { question: "What is the purpose of error handling?", options: ["To make programs slower", "To prevent programs from crashing when errors occur", "To cause errors on purpose", "To delete the file"], correctIndex: 1, explanation: "Error handling allows programs to respond gracefully to unexpected situations instead of crashing.", hint: "Without try/except, a single error would crash the entire program.", difficulty: "easy" },
      { question: "What is the correct order of try/except/finally?", options: ["except, try, finally", "try, except, finally", "finally, try, except", "try, finally, except"], correctIndex: 1, explanation: "The correct order is: try → except → finally.", hint: "Pseudocode: TRY first (the risky code), CATCH/EXCEPT second (handle errors), FINALLY last (cleanup).", difficulty: "medium" },
      { question: "Can you have multiple except blocks?", options: ["No, only one", "Yes, for different error types", "Only with finally", "Only in functions"], correctIndex: 1, explanation: "You can have multiple except blocks, each handling a different exception type.", hint: "Pseudocode: TRY\n    ...\nCATCH ValueError\n    ...\nCATCH ZeroDivisionError\n    ...", difficulty: "medium" },
      { question: "What does 'except Exception as e' do?", options: ["Catches only Exception errors", "Catches any error and stores it in variable e", "Creates a new exception", "Raises an error"], correctIndex: 1, explanation: "This catches any exception and stores the error message in variable 'e' for inspection.", hint: "The 'as e' part saves the error object so you can print(e) to see what went wrong.", difficulty: "hard" },
      { question: "What is defensive programming?", options: ["Programming with antivirus", "Writing code that anticipates and handles potential errors", "Using strong passwords", "Encrypting all variables"], correctIndex: 1, explanation: "Defensive programming means writing code that handles unexpected inputs and edge cases gracefully.", hint: "This approach assumes users will make mistakes and prepares for them with validation and error handling.", difficulty: "hard" }
    ]
  },
