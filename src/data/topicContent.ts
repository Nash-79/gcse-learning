...
if pwd == "python123":
    ...
    videoUrl: "https://www.youtube.com/embed/PqFKRqpHrjw",
    quiz: [
      { question: "What symbol is used to check if two things are equal?", options: ["=", "==", "===", "!="], correctIndex: 1, explanation: "== checks equality. A single = assigns a value to a variable." },
      { question: "What is missing from this line: if score > 50", options: ["Then", "Brackets", "A colon (:)", "A semicolon (;)"], correctIndex: 2, explanation: "All selection statements in Python must end with a colon." },
      { question: "What does 'elif' stand for?", options: ["Else If", "End If", "Either If", "Equal If"], correctIndex: 0, explanation: "elif is short for 'else if'." },
      { question: "How does Python know which code belongs inside an if statement?", options: ["Curly brackets {}", "End if", "Indentation", "Semicolons"], correctIndex: 2, explanation: "Python uses indentation (spacing at the start of the line) to group blocks of code." },
      { question: "Which operator means 'Not Equal To'?", options: ["<>", "!==", "not=", "!="], correctIndex: 3, explanation: "!= means not equal to in Python." }
    ]
  },
...
for i in range(1, 13):
    ...
    quiz: [
      { question: "How many times will range(5) loop?", options: ["4", "5", "6", "0"], correctIndex: 1, explanation: "range(5) generates 0,1,2,3,4 — that's 5 values." },
      { question: "What type of loop runs as long as a condition is True?", options: ["for loop", "while loop", "repeat loop", "do loop"], correctIndex: 1, explanation: "While loops continue as long as their condition evaluates to True." },
      { question: "What does range(2, 10, 2) generate?", options: ["2,4,6,8,10", "2,4,6,8", "0,2,4,6,8", "2,3,4,5,6,7,8,9,10"], correctIndex: 1, explanation: "range(2, 10, 2) starts at 2, stops before 10, stepping by 2: 2,4,6,8." },
      { question: "Which keyword exits a loop immediately?", options: ["stop", "exit", "break", "end"], correctIndex: 2, explanation: "break immediately terminates the current loop." },
      { question: "What will happen if a while loop condition never becomes False?", options: ["The program crashes", "An infinite loop occurs", "The loop runs once", "A syntax error occurs"], correctIndex: 1, explanation: "An infinite loop runs forever until the program is force-stopped." }
    ]
  },
...
print("All scores:", scores)`
    ...
    quiz: [
      { question: "Which brackets are used to create a List?", options: ["()", "{}", "[]", "<>"], correctIndex: 2, explanation: "Lists use square brackets []." },
      { question: "If names = ['Ali', 'Bob', 'Charlie'], what is names[1]?", options: ["Ali", "Bob", "Charlie", "Error"], correctIndex: 1, explanation: "Lists are zero-indexed, so names[0] is Ali, and names[1] is Bob." },
      { question: "What is the main difference between a List and a Tuple?", options: ["Tuples hold numbers, Lists hold strings", "Tuples cannot be changed after creation", "Lists are faster", "Tuples use square brackets"], correctIndex: 1, explanation: "Tuples are immutable, meaning they cannot be modified once created." },
      { question: "In a dictionary, data is stored in pairs. What are these called?", options: ["Item-Value", "Key-Value", "Name-Data", "Index-Value"], correctIndex: 1, explanation: "Dictionaries store data in Key-Value pairs." },
      { question: "How do you add a new item to the end of a list?", options: ["list.add()", "list.insert()", "list.append()", "list.push()"], correctIndex: 2, explanation: "The append() method adds an item to the end of a list." }
    ]
  },
...
print("Room 2 area:", r2, "m²")`
    ...
    quiz: [
      { question: "Which keyword is used to define a function?", options: ["function", "define", "def", "func"], correctIndex: 2, explanation: "In Python, functions are defined using the 'def' keyword." },
      { question: "What does the 'return' statement do?", options: ["Prints a value", "Sends a value back from the function", "Ends the program", "Creates a new variable"], correctIndex: 1, explanation: "return exits the function and sends a value back to where it was called." },
      { question: "A variable created inside a function has:", options: ["Global scope", "Local scope", "No scope", "Module scope"], correctIndex: 1, explanation: "Variables defined inside a function are local — they only exist within that function." },
      { question: "What is it called when you execute/run a function?", options: ["Defining", "Returning", "Calling", "Declaring"], correctIndex: 2, explanation: "You 'call' a function by writing its name with parentheses." },
      { question: "What is a function parameter?", options: ["The return value", "A variable inside a function that receives a passed value", "The function's name", "A global variable"], correctIndex: 1, explanation: "Parameters are the variables listed in the function definition that receive the arguments passed to it." }
    ]
  },
...
print("Your username is:", username)`
    ...
    quiz: [
      { question: "What does 'Python'[2:5] return?", options: ["Pyt", "tho", "thon", "Pyth"], correctIndex: 1, explanation: "Slicing is exclusive of the stop index. Index 2='t', 3='h', 4='o'." },
      { question: "Which method removes whitespace from both ends of a string?", options: ["trim()", "clean()", "strip()", "remove()"], correctIndex: 2, explanation: "strip() removes leading and trailing whitespace characters." },
      { question: "What does 'hello'.upper() return?", options: ["Hello", "HELLO", "hello", "hELLO"], correctIndex: 1, explanation: "upper() converts all characters to uppercase." },
      { question: "What is the result of 'a,b,c'.split(',')?", options: ["'a b c'", "['a', 'b', 'c']", "('a', 'b', 'c')", "Error"], correctIndex: 1, explanation: "split() divides a string at a delimiter and returns a list." },
      { question: "Are Python strings mutable (changeable)?", options: ["Yes, always", "No, they are immutable", "Only if created with single quotes", "Only if assigned to a variable"], correctIndex: 1, explanation: "Strings are immutable. String methods return new strings — the original cannot be changed in place." }
    ]
  },
