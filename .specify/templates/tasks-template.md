...
**Tests**: The examples below include test tasks. Tests are OPTIONAL unless
required by the constitution, feature specification, or the change affects AI
fallback behavior, curriculum validation, or learner-facing correctness.
...
- [ ] T004 [P] Capture constitution-driven validation requirements for this feature
...
Include these whenever the story changes learner-facing correctness, curriculum
content, or AI routing/fallback behavior.
...
- [ ] T013 [P] [US1] Content validation or golden-answer check in [path]
...
- [ ] T019 [US1] Add logging or provenance for user story 1 operations
...
- [ ] T022 [P] [US2] Content validation or golden-answer check in [path]
...
- [ ] T029 [P] [US3] Content validation or golden-answer check in [path]
...
- [ ] TXXX Reconcile curriculum coverage claims with validated repository state
